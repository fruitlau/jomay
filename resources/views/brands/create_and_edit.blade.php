        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                	<label for="name-field">品牌名称 <span class="text-danger"> （ 20字以内 ）</span> </label>
                ...
                <div class="form-group">
                    <label for="major_models-field">主要型号 <span class="text-danger"> （ 500字以内 ）</span></label>
